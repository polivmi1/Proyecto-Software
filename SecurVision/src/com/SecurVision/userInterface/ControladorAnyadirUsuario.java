...
public class ControladorAnyadirUsuario{
	...
	private void initialize(){
		...
		//TODO cambiar cuando est� Nivel, que zonas es para probar
			...
			if(newPerson !=null){
				try {
					...
					if(btnGuardia.isSelected()){
						frame.Alert(AlertType.INFORMATION,"Par�metros Guardia", "Como el usuario creado era un guadia, debe proporcionale credenciales de acceso");
